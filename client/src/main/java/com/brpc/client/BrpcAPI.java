...
@RestController
@RequestMapping("/brpc")
public class BrpcAPI implements ApplicationContextAware {
    ...
    private static final QcLog LOG = LogUtil.getLogger(BrpcAPI.class);
    ...
    public Object test(String className, String methodName, RequestType requestType, @RequestBody Object request) throws Exception {
